...
const HomeResponsibleVehicleUser = () => {
  const { id } = useParams();
  ...
  const getResponsibles = async () => {
    const response =
      token && (await vehicleResponsibleApi.getByIdToken(id, token));
      ...
      <div className="vehicle-wrapper">
        <div className="vehicle-container">
          <Toolbar
            ...
            to={`/dashboard/user/vehicle/responsibles/create/${id}`}
            title="Cadastrar"
          />
...
export default HomeResponsibleVehicleUser;
