export * from "@/domain/contracts/prisma/generic-repository";
export * from "@/domain/contracts/prisma/college-repository";
export * from "@/domain/contracts/prisma/garage-repository";
export * from "@/domain/contracts/prisma/user-repository";
